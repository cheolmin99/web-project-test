...
import { FILE_UPLOAD_URL, GET_MY_LIKE_LIST_URL, GET_MY_LIST_URL, PATCH_PROFILE_URL, SEARCH_TAG_URL, authorizationHeader, mutipartHeader } from "src/constants/api";
...
export default function MyPageView() {
    ...
    const getMyList = () => {
        axios.get(GET_MY_LIST_URL, authorizationHeader(accessToken as string))
        .then((response) => getMyListResponseHandler(response))
        .catch((error) => getMyListErrorHandler(error));
    }

    const getMyLikeList = () => {
        axios.get(GET_MY_LIKE_LIST_URL, authorizationHeader(accessToken as string))
